...
rem %USERPROFILE%\scoop\apps\git\current\git-bash --command=usr\bin\mintty.exe /usr/bin/bash -c ./init.sh

rem Run in a new cmd environment
cmd /c "%USERPROFILE%\scoop\apps\git\current\bin\bash -c ./init.sh"
